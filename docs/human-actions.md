...
Што зрабіць: праверце і змержуйце PR #173 — арыенцір памеру (файл ≲ 400 радкоў / кантракт ≲ 12 публічных метадаў → рэв'юер піша адну фразу) у `docs/agent-rules/code-review.md` + структурны гард. Незалежнае рэв'ю раўнд 1 знайшло 3 Medium + 2 Low — усе выпраўленыя ў 6a6556d; вердыкт раўнда 2 і суддзі — у сесіі з пазнакай праз квотны зрыў спаўна субагента.
PR: https://github.com/vokhandcrafts/KUDY/pull/173 (issue #167)

### 2026-09-22 — мерж PR #170 (G18.02 — слоўнік дамена)
Што зрабіць: праверце і змержуйце PR #170 — слоўнік дамена `docs/architecture/25_domain_vocabulary.md` (41 тэрмін з канонам 01/09/15/19/21, кожны з `_Avoid_`) + структурны гард табліцы. Незалежнае рэв'ю знайшло толькі 1 Medium (састарэлыя лічбы) — выпраўлена ў 2db8781; вердыкт суддзі — у сесіі з пазнакай праз квотны зрыў спаўна субагента. Пасля мержу знімце `agent:running` з issue #165.
