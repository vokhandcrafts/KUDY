...
### 2026-09-23 — мерж PR #226 (G17.01.b — сыравы здымак, пашпарт, дэдуп, рэзюм)
Што зрабіць: праверце і змержуйце PR #226 у main — здымкавы канвеер калектара (file://-мяжа без сеткі, дэдуп па URL і content_hash, рэзюм, дыягностыкі на сапсаваных фікстурах); рэвью ✅ (2 Low у каментары рэвью), суддзя пацвердзіць у сваім каментары. Пасля мержу зніміце `agent:running` з закрытай issue #156 (зачыніцца аўтаматычна праз «Closes #156»).
PR: https://github.com/vokhandcrafts/KUDY/pull/226 (issue #156)
