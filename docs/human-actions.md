...
Што зрабіць: праверце і змержуйце PR #152 — чарнавік спецыфікацыі 24 (збор з сеткі: кампаніі, паўзук з парканам, фота з суаднясеннем да тэксту, субтытры YouTube) і брыфы задач G17. Пасля мержу адкажыце ў tracking-ісью #153 на пяць рашэнняў заснавальніка: зацвярджэнне спецыфікацыі, пілотны навінны партал, патрэба ў распазнанні голасу, слоўнік тэм, крыніцы фота для гайдаў — без іх пілот G17.08 не стартуе. Каб запусціць распрацоўку, паставьце на эпік #154 пазнаку `epic`, а на задачах #155–#163 — `agent:ready`/`prio:*` (пазнакі ставіць толькі аператар).
PR: https://github.com/vokhandcrafts/KUDY/pull/152 (эпік #154, задачы #155–#163, tracking #153)
