...
### 2026-09-23 — выбраць, якія новыя задачы G01.05/G04/G05.01 запускаць
Праглядзіце задачы #185–#199 і #201 і пастаўце `agent:ready` на тыя, што можна пачынаць (без адкрытых Blocked-by: #186, #189, #193, #197). Памятайце: Zcode можа ўзяць адкрытую задачу і без гэтай пазнакі. Перад запускам #187 запішыце ў ёй, што ADR G01.05 прыняты.
Issue: https://github.com/vokhandcrafts/KUDY/issues/185 (і #188, #192, #196)
