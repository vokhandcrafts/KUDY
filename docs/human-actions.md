...
### 2026-09-24 — мерж PR #231 (G04.02.a — staging, пахвёрбавая праверка, атамарная актывацыя)
Што зрабіць: праверце і змержуйце PR #231 у main — актывацыйнае ядро `services/download` (staging побач з фінальным пластам, пер-файлавы sha256 па сырых байтах, адзіны атамарны rename, рэзюмаванне па хэшу, крэш-інварыянты ADR G01.03 §3.7, `bundle_asset` праз public API services/db). Код-рэвью ✅ (0 critical · 0 high), суддзя пацвердзіць у сваім каментары (👍 на каментары рэвью = можна мержыць); issue #189 закрываецца мержам.
PR: https://github.com/vokhandcrafts/KUDY/pull/231 (issue #189)
