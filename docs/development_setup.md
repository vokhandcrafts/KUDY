...
| npm | `>= 10.9.8 < 13` | лініі 10.9.8 і 11.x правераныя практыкай; 12.x — pacman-пакет дэв-хоста CachyOS (12.0.2), пашырэнне дыяпазону зняла EBADENGINE-шум — праверка `npm ci` на 12 — адна з наступных праверак дэв-хоста |
