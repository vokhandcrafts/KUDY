...
`^8.5.23 || 8.4.31`, `~>8.5.22`, `8.4.31 - 8.6.0`, якія стары код
прымае ці адхіляе супраць чакання) і «cannot fully enumerate» (на
`latest`, `^8.5.23 || latest`, `^8.5.23 || next`, `8.5.x || ^8.5.23`,
`<8.6.0`, `^8.5.23 || <8.6.0`, `>8.5.22-beta.1`, `8.5.23 - 8.6`);
