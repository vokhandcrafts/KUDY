...
**Дэталізацыя 2026-09-15:** класавы і модульны ўзровень, каталог інтэрфейсаў, уладальнікі стану і праходы сцэнараў — [19](19_class_and_module_map.md). Гэтая схема застаецца крыніцай меж і патокаў; мапа не ўводзіць другіх палёў і другіх дыяграм кантураў.
