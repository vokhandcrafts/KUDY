...
Навігацыйны кантракт па-за Run — Горад → Гіды → прэв'ю, Back, пустыя станы, locked-прэв'ю і вяртанне з ацэнкі — [11, раздзел 16](../11_run_interaction.md).
